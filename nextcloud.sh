...
certbot certonly --standalone -d "cloud.bojanmilevski.com" -d "www.cloud.bojanmilevski.com"

echo 'server {
	listen 80;
	listen [::]:80;
	return 301 https://$host$request_uri;
	server_name cloud.bojanmilevski.com www.cloud.bojanmilevski.com
}
...
server {
	...
	ssl_certificate /etc/letsencrypt/live/cloud.bojanmilevski.com/
	ssl_certificate_key /etc/letsencrypt/live/cloud.bojanmilevski.com/
